...
<hr/>
<h3>Install</h3>
<p><strong>Known Bug</strong>: Enguage is under a process of refactoring and a bug has crept in whereby the unit test doesn't work first time around. Just re-run it, it seems to work on subsequent runs! Will be fixed, asap!</p>
<h2>Notes</h2>
