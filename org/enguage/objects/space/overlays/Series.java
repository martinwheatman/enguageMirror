...
public class Series { // relates to hypothetical attachment of series of overlays to fs 
	...
	static public  String  base() { return detached() ? DETACHED : Link.toString( path());}
	...
	static public boolean existing() { return !detached()  && Fs.exists( path() + Link.EXT );}
