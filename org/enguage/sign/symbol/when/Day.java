...
public class Day {
	...
	public static When getWhen( Strings sa ) { // [ "1225" ]
		...
		if (sa.size() > 0) {
			try {
				...
				audit.debug( "When.day(): exception: "+ e.toString() );
		}	}
		return w;
	}
	...
	public static void main( String args[]) {
		//audit.debug("days to end of year: "+ daysToEndOfYear( 20161231000000L ));
		//audit.tracing = true;
		audit.debug("day of year: "+ dayOfYear( 20160227000000L ));
		audit.debug("day of year: "+ dayOfYear( 20160228000000L ));
		audit.debug("day of year: "+ dayOfYear( 20160229000000L ));
		audit.debug("day of year: "+ dayOfYear( 20160301000000L ));
		audit.debug("day of year: "+ dayOfYear( 20160302000000L ));
}	}
