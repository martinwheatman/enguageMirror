...
/*		} else if (cmd.equals( "temporal" )) {
	...
	*/		
			...
			if (Enguage.lastOutput() == null) {
				...
				audit.log("Engine:repeating: "+ Enguage.lastOutput());
				r.repeated( true );
			...
			helped( true );
			r.format( Repertoire.engin.helpedToString( NAME ));
	...
	public static void main( String args[]) {
		...
		Engine e = new Engine( "engine", "temporal meeting" );
